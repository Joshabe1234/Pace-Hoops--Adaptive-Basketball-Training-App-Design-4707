        ...
        <div className="bg-slate-800 rounded-xl border border-slate-700 overflow-hidden">
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm font-medium text-red-400">Removed Players ({team.blockedPlayerIds.length})</span>
            </div>
            <svg
              className={`w-4 h-4 text-slate-400 transition-transform ${showBlocked ? 'rotate-180' : ''}`}
                ...
                return (
                  <div key={blockedId} className="flex items-center justify-between px-4 py-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-slate-300">{blockedUser?.name || 'Unknown Player'}</p>
                        <p className="text-xs text-slate-500">Permanently removed</p>
                      </div>
                    </div>
                  </div>
                );
        ...
        {showRemoveConfirm && (
          ...
          >
            ...
            >
              ...
              <p className="text-slate-400 mb-2">This will permanently remove the player from your team.</p>
              <p className="text-red-400 text-sm mb-6">They will not be able to rejoin using the team code.</p>
