...
const PlayerStats = ({ user, team }) => {
  const [stats, setStats] = useState({ totalLogs: 0, shooting: { makes: 0, attempts: 0, percentage: null }, completionRate: null, soreness: {} });
    ...
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl p-6">
          ...
          <p className="text-4xl font-bold text-white">{stats.completionRate === null ? '—' : `${stats.completionRate}%`}</p>
        </div>
      </div>
